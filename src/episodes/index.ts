...
const POWERBI_EPISODES: EpisodeSeed[] = [
  ...
  },
  {
    ...
    number: 5,
    title: 'The library',
    hook: 'One brick is a trick; a set is a product. A reusable, branded, governed component library — and the registry that lets a report be assembled instead of hand-built.',
    date: '2026-05-26',
    primaryLanguage: 'typescript',
    languages: ['typescript', 'd3'],
    tags: ['modular-visual-intelligence', 'library', 'registry'],
    readingMinutes: 17,
    source: 'concepts/modular-visual-intelligence.md',
  },
  {
    ...
    hook: 'A natural-language brief in, a PBIP report assembled from governed library modules out — no visual dragged by hand. The Engine doing what the method used to do carefully.',
    date: '2026-05-26',
    primaryLanguage: 'typescript',
    languages: ['typescript', 'json'],
    tags: ['agent', 'pbip', 'assembly', 'engine'],
    readingMinutes: 20,
    source: 'docs/agents/agent-runtime.md · strategy/why-now.md (PBIP)',
  },
  {
