...
---
Thank you for your interest in contributing to The Data Shrink. This page will walk you through the process of preparing and submitting your idea. If you haven't done so already, please review our [call for contributions](call-for-contributions.qmd) before continuing.

## Site functionality and ethos
The Data Shrink is built on [Quarto](https://quarto.org/), the new open-source publishing system developed by [Posit](https://posit.co/). The site has been designed from the ground up as a platform for data scientists, created by data scientists. Here’s what this means in practice:  
...
For more on how to work with The Data Shrink via GitHub, check out our [repository README](https://github.com/realworlddatascience/realworlddatascience.github.io/blob/main/README.md).

## The submission process
1. Contact [The Data Shrink](mailto:rwds@rss.org.uk) to discuss your proposed submission.
...
2. Write up a short content brief containing the following:
    ...
    The [RWDS_post_template repository](https://github.com/finnoh/RWDS_post_template) on GitHub contains a Quarto document (content-brief.qmd) that can be used to produce a content brief in the style and format of a The Data Shrink article.
...
4. Draft submissions should be sent via email to [The Data Shrink](mailto:rwds@rss.org.uk). Alternatively, contributors can commit their drafts to their own GitHub accounts using the [RWDS_post_template repository](https://github.com/finnoh/RWDS_post_template) and the repository link then shared with [The Data Shrink](mailto:rwds@rss.org.uk).

> For more information on how to work with The Data Shrink via GitHub, check out our [GitHub repository README](https://github.com/realworlddatascience/realworlddatascience.github.io/blob/main/README.md).
...
Contributors also have the option of uploading the source code and files for their articles to [Zenodo](https://zenodo.org/), an open science repository, and submitting this material to the [The Data Shrink community](https://zenodo.org/communities/realworlddatascience). When a Zenodo record is created, a DOI is assigned, and this DOI can then be added to your published article on The Data Shrink. For more details on working with Zenodo, see [help.zenodo.org](https://help.zenodo.org/).

<!-- The Data Shrink will also promote new content regularly via a newsletter, which users of the platform can sign up to receive. We will also look to partner with other newsletter publishers so that The Data Shrink content is featured within their mailings. -->
