...
4. Contact [The Data Shrink](mailto:rwds@rss.org.uk) to discuss. 
...
DataScienceBites is published by The Data Shrink and is part of the [ScienceBites](https://sciencebites.org/) [galaxy of sites](https://sciencebites.org/sciencebites-sites-galaxy/). See [sciencebites.org](https://sciencebites.org/about/) for an overview of the ScienceBites mission.